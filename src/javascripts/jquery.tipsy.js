    ...
    Tipsy.prototype = {
        show: function () {
            ...
            if (title && this.enabled) {
                ...
                // NSOMS. Fixes tip top and left offset for WebKit browsers.
                // this.$element is g node within svg. It is not block element, so its offset is {0, 0}.
                // We point it to internal block div element - IT ONLY WORKS FOR INTERNAL SETTINGS IN Dagre Node SETTINGS!
                // var pos = $.extend({}, this.$element.offset(), {
                var pos = $.extend({}, $('div', this.$element).offset(), {
        ...
        fixTitle: function () {
            ...
            if (typeof $e.context == 'object' && typeof $e.context.nearestViewportElement == 'object') {
